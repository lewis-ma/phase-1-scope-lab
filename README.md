...
- `setBestCustomer()`: Write a function that when called, declares a variable
   ...
   explore right now.
- `overwriteBestCustomer()`: See t# Instructions
...
when specifically instructed otherwise. We do this because, by testing thehe consequences of declaring a variable in
